...
if (isset($_GET['page_id'])) {
    if (isset($_POST['name'], $_POST['rating'], $_POST['content'])) {
        ...
        exit('Đánh giá của bạn đã được ghi nhận!');
    }
...
<a href="#" class="write_review_btn">Nhận Xét</a>
<div class="write_review">
    <form>
        <input name="name" type="text" placeholder="Tên bạn" required>
        <input name="rating" type="number" min="1" max="5" placeholder="Điểm (1-5)" required>
        <textarea name="content" placeholder="Viết đánh giá tại đây..." required></textarea>
